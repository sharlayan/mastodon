...
namespace :api, format: false do
  ...
  namespace :misskey_compat, path: '' do
    ...
    post 'flash/create', to: 'flash#noop'
    post 'flash/delete', to: 'stub#no_content'
    ...
    post 'request-reset-password', to: 'stub#no_content'
    post 'reset-db', to: 'stub#no_content'
    post 'reset-password', to: 'stub#no_content'
    post 'retention', to: 'stub#empty'
    post 'reversi/cancel-match', to: 'stub#no_content'
    post 'reversi/games', to: 'stub#empty'
    post 'reversi/invitations', to: 'stub#empty'
    post 'reversi/match', to: 'stub#noop'
    post 'reversi/show-game', to: 'stub#noop'
    post 'reversi/surrender', to: 'stub#no_content'
    post 'reversi/verify', to: 'stub#noop'
