...
class ActivityPub::Activity::Create < ActivityPub::Activity
  ...
  def process_quote
    ...
    @quote = Quote.new(account: @account, approval_uri: approval_uri, legacy: @status_parser.legacy_quote?, state: @status_parser.deleted_quote? ? :deleted : :pending, from_misskey: @status_parser.from_misskey?)
  end
