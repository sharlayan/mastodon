...
class ActivityPub::Activity::Create < ActivityPub::Activity
  ...
  def process_emoji(tag)
    ...
    return unless emoji.nil? || custom_emoji_parser.image_remote_url != emoji.image_remote_url || (!custom_emoji_parser.sensitive.nil? && custom_emoji_parser.sensitive != emoji.is_sensitive?) || (custom_emoji_parser.updated_at && custom_emoji_parser.updated_at >= emoji.updated_at)
  ...
  def related_to_local_activity?
    ...
    when :public, :unlisted
      followed_by_local_accounts? || accepted_through_relay? || responds_to_followed_account? || addresses_local_accounts?
    when :private
