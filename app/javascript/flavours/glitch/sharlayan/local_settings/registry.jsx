...
const localSettingsSlots = {
  'general-after-rewrite': [
    ...
    { setting: ['hide_timeline_account_handle'], id: 'mastodon-settings--hide_timeline_account_handle', message: { id: 'settings.hide_timeline_account_handle', defaultMessage: 'Hide account handles on timeline posts' }, hint: { id: 'settings.hide_timeline_account_handle.hint', defaultMessage: 'Show only display names in the account information area of timeline posts' } },
  ...
  'compose-form': [
    { setting: ['floating_compose_button'], id: 'mastodon-settings--floating_compose_button', message: { id: 'settings.floating_compose_button', defaultMessage: 'Use a floating compose button on mobile' } },
    ...
    { setting: ['inline_compose_expand_on_click'], id: 'mastodon-settings--inline_compose_expand_on_click', message: { id: 'settings.inline_compose_expand_on_click', defaultMessage: 'Expand the inline compose box when clicked' }, hint: { id: 'settings.inline_compose_expand_on_click.hint', defaultMessage: 'Keep the inline compose box compact until you click it, similar to Twitter' }, dependsOn: ['inline_compose_timelines'] },
    { setting: ['disable_inline_compose_reply_modal'], id: 'mastodon-settings--disable_inline_compose_reply_modal', message: { id: 'settings.disable_inline_compose_reply_modal', defaultMessage: 'Do not use a popup for replies on desktop' }, hint: { id: 'settings.disable_inline_compose_reply_modal.hint', defaultMessage: 'When inline compose is enabled in desktop single-column mode, use the compose box at the top of the timeline for replies; detailed posts will return to the timeline' } },
    { setting: ['disable_mobile_reply_modal'], id: 'mastodon-settings--disable_mobile_reply_modal', message: { id: 'settings.disable_mobile_reply_modal', defaultMessage: 'Do not use a popup for replies on mobile' }, hint: { id: 'settings.disable_mobile_reply_modal.hint', defaultMessage: 'Open the compose page for replies on mobile. This is enabled by default' } },
