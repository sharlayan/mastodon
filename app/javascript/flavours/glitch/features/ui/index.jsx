...
import { initialState, forceSingleColumn, me, owner, singleUserMode, trendsEnabled, landingPage, localLiveFeedAccess, disableHoverCards, domain, isServerPageBlogViewPath, federatedTimelineEnabled, localTimelineEnabled, collectionsEnabled } from '../../initial_state';
...
class SwitchingColumnsArea extends PureComponent {
  ...
  render () {
    const { children, pageBlogView, singleColumn, forceOnboarding, minimalShell } = this.props;
