    ...
    <Column bindToDocument={!multiColumn} ref={columnRef} label={intl.formatMessage(messages.title)}>
      ...
      {conversationsMode ? (
        <ConversationsList
          ...
          prepend={<div className='follow_requests-unlocked_explanation'><span>{roleplayMode && <><FormattedMessage id='compose_form.rp_server_dm_warning' defaultMessage='Server administrators can read direct messages for moderation.' /> </>}<FormattedMessage id='compose_form.encryption_warning' defaultMessage='Posts on Mastodon are not end-to-end encrypted. Do not share any dangerous information over Mastodon.' /> <a href='/terms' target='_blank'><FormattedMessage id='compose_form.direct_message_warning_learn_more' defaultMessage='Learn more' /></a></span></div>}
          alwaysPrepend
        />
      ) : (
        <StatusListContainer
