...
class InitialStateSerializer < ActiveModel::Serializer
  ...
  def meta
    ...
    if object.current_account
      ...
      store[:custom_emoji_mutes]                = object.current_account.custom_emoji_mutes.order(id: :desc).map { |mute| { id: mute.id.to_s, prefix: mute.prefix, domain: mute.domain, reject_reactions: mute.reject_reactions } }
