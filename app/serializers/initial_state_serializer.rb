  ...
  def default_meta_store
    {
      ...
      background_image: instance_presenter.background_image&.file&.url,
      background_color: Setting.background_color,
      background_opacity: Setting.background_opacity,
      background_on_settings_pages: Setting.background_on_settings_pages,
      glitch_mascots: instance_presenter.glitch_mascots.map { |upload| upload&.file&.url },
