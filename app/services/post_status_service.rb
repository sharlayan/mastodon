...
class PostStatusService < BaseService
  ...
  def preprocess_attributes!
    ...
    @sensitive = @sharlayan_pipeline.sensitive?
    @visibility = @sharlayan_pipeline.visibility
    @quoted_status = @sharlayan_pipeline.quoted_status
  ...
  def process_status!
    ...
    @sharlayan_pipeline.prepare_status!(@status, process_mentions_service) do
    ...
    @sharlayan_pipeline.persist_status!(@status, media: @media) do
      @status.save!
    end
  end
  ...
  def schedule_status!
    ...
    if status_for_validation.valid?
      ...
      @sharlayan_pipeline.persist_scheduled!(media: @media) do
  ...
  def postprocess_status!
    ...
    @sharlayan_pipeline.after_commit!(@status) do
